...
mean_dat.to_csv(os.path.join(plot_dir, "figure1/cell_cluster_marker_means.csv"))

# read previously generated
mean_dat = pd.read_csv(os.path.join(plot_dir, "figure1/cell_cluster_marker_means.csv"))
